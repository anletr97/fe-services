    ...
    <section className="bg-pink-light pt-6 pb-6">
      <div className="container">
            ...
            <div className="campaign-dn">
              ...
              <div className="campaign-dn-body">
                <h5 className="campaign-dn-title">
                  “Trao lạc quan vượt qua nghịch cảnh” cho trẻ em và người già neo
                  đơn tại các mái ấm cùng Trăng Khuyết
                </h5>
                <p className="campaign-dn-summary">
                  Cùng chung tay đóng góp sửa chữa lại cơ sở vật chất tại mái ấm để
                  đem đến niềm vui cho các cụ già. Xây dựng những chương trình chăm
                  sóc tinh thần, trò chuyện, văn nghệ và động viên các cụ vượt qua
                  đau buồn.
                </p>
              </div>
        ...
        <div className="row mt-5 justify-content-center">
          <a className="btn btn-primary btn-blue font-weight-bold "> Xem thêm </a>
        </div>
      </div>
    </section>
  );
